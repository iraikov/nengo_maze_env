...
def eval_srf_autoenc(params, input_dimensions, input_data, input_encoders,
    ...
    n_steps_train = n_steps_frame * train_size
...
if __name__ == '__main__':
    ...
    space = {'w_initial_E': [1e-5, 1e-1],
             ...
             'sigma_scale_E': [0.001, 0.1],
             'sigma_scale_EI': [0.001, 0.1],
             'sigma_scale_EI_Ext': [0.001, 0.1],
             'sigma_scale_EE': [0.001, 0.1],
             'sigma_scale_I': [0.001, 0.1],
            }
