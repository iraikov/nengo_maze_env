...
normed_train_image_array = train_image_array
normed_test_image_array = test_image_array
...
ngram_n = 2
ngram_decoder_exc_rates = fit_ngram_decoder_rates(exc_rates_train, train_labels[1:], n_labels, ngram_n, {})
exc_rates_predictions_train = predict_ngram_rates(exc_rates_train, ngram_decoder_exc_rates, n_labels, ngram_n)
exc_rates_train_score = accuracy_score(train_labels[1:], exc_rates_predictions_train)
print(f'exc_rates_predictions_train = {exc_rates_predictions_train} exc_rates_train_score = {exc_rates_train_score}')

exc_rates_predictions_test = predict_ngram_rates(exc_rates_test, ngram_decoder_exc_rates, n_labels, ngram_n)
exc_rates_test_score = accuracy_score(test_labels, exc_rates_predictions_test)
